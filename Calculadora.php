...
<head>
    ...
    <title>Calculadora dos guri</title>
...
<body>
    <form>
        <div class="cabecalho">
            <h1>Calculadora dos Guri<br>
            <img src="https://pbs.twimg.com/profile_images/816734677298008064/CKWCl_OL_400x400.jpg"
                alt="">
            </h1>
        </div>
        Primeiro número
    ...
    <table>
        ...
        <tr>
            <td><?php echo $operacao['nr1']; ?></td>
            <td><?php echo $operacao['nr2']; ?></td>
            <td><?php echo $operacao['calcular']; ?></td>
            <td><?php echo is_array($operacao['resultado']) ? implode(', ', $operacao['resultado']) : $operacao['resultado']; ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
